...
$Latest['Latest']         = "Gli ultimi messaggi scritti ";
$View_all['View_all']     = "Vedi tutti";
$all['all']               = "Tutti i messaggi";
$P_topics['P_topics']     = "Discussioni popolari";
$click['click']           = " cliccare ";
$code_forum['code_forum'] = " per vedere le Regole del Forum.";
$here['here']             = "qui";
$Account['Account']       = "Account";
$Account1['Account1']     = "Impossibile connettersi?";
$Account3['Account3']     = "Crea un account";
...
$Support3['Support3']   = "Articoli di supporto";
$Support4['Support4']   = "Aiuto! Sono Hacked!";
$Support5['Support5']   = "Vedere i nostri articoli di supporto";
$Support6['Support6']   = "Creare un biglietto supporto";
$Support7['Support7']   = "Vedere i biglietti attivi di supporto.";
$Support8['Support8']   = "Knowledge Center";
$Support9['Support9']   = "Fare una domanda";
$Support10['Support10'] = "Vostri biglietti di supporto";
$Support11['Support11'] = "Ottenere aiuto ed esplorare la base di conoscenza.";

$Games['Games']               = "Jeu";
$Client_down['Client_down']   = "Scarica il client di gioco";
$Client_down3['Client_down3'] = "Scarica il client d'installazione";
...
$copyright3['copyright3']    = "Sviluppato da AquaFlame CMS";
$copyright4['copyright4']    = "Le risorse sono di proprietà di Blizzard Entertainment.";

$Welcome['Welcome'] = "Benvenuto, ";
$logout['logout']   = "Logout";
$login['login']     = "Collegamento";

$Donate1['Donate1'] = "Fare una donazione a";
$Donate['Donate']   = "Fare una donazione";

$website['explore']   = "Esplorare";
$More['More']         = "Di pi&ugrave;";
