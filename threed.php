											...
											<div class="summary-top">
												<div class="summary-top-right">
													<ul class="profile-view-options" id="profile-view-options-summary">
														<li class="current">
															<a href="threed.php?name=<?php echo $character->getObjectInfo()->name;?>" rel="np" class="threed"><?php echo $armory['3d']; ?></a>
														</li>
														<li>
															<a href="advanced.php?name=<?php echo $character->getObjectInfo()->name;?>" rel="np" class="advanced"><?php echo $armory['advanced']; ?></a>
														</li>
													</ul>
																...
																22 => 'worgen');
																    ...
																    if (mysql_num_rows($query_select_guid) != 0) 
																    {
																        ...
																        while($row_select_guid = mysql_fetch_array($query_select_guid))
																        {
																            ...
																            $query_select_itemData = mysql_query("SELECT data FROM item_instance WHERE guid = '$item'");
																            if (mysql_num_rows($query_select_itemData) != 0) 
																            {
																                while ($row_itemData = mysql_fetch_array($query_select_itemData)) 
																                {
																                    $itemData = str_getcsv($row_itemData['data'], " ");
																                    $itemEntry = $itemData[3];
																                    if ($itemEntry != "") {
													...
													<div class="summary-stats-profs-bgs">
														...
														<div class="summary-stats-bottom">
															<div class="summary-battlegrounds">
																<ul>
																	<li class="rating">
																		<span class="name">Total Honor</span><span class="value"><?php echo @$honor ?></span>
																		<span class="clear">
																			<!-- -->
																		</span>
																	</li>
																	<li class="kills">
																		<span class="name">Total Conquest</span><span class="value"><?php echo @$conq ?></span>
																		<span class="clear">
																			<!-- -->
																		</span>
																	</li>
