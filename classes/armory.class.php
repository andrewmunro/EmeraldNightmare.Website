...
class Armory_Character extends Armory {
    ...
    private function _parseEquipmentCache() {
        ...
        foreach ($this->_getEquipedItems() as $slot => $item) {
            if ($item[0] == NULL) {
                ...
                $itemTemplate = $this->getWorldDb()->getItemInfo($item["item_template"]);
                $result[$slot] = array($item["item_template"], $slot, $itemTemplate->InventoryType, $itemTemplate, new wowheadparser($item["item_template"]));
            }
        }
    ...
    private function _getWeaponForClass() {
        ...
        switch ($this->getObjectInfo()->class) {
            case 1: $result = array(17, 14, 15);
                break;
            case 2: $result = array(17, 14, 28);
                break;
            case 3: $result = array(21, 22, 15);
                break;
            case 4: $result = array(21, 22, 25);
                break;
            case 8:
            case 9:
            case 5: $result = array(21, 23, 26);
                break;
            case 11:
            case 6: $result = array(21, 22, 28);
                break;
            case 7: $result = array(21, 22, 26);
                break;
        }
        return $result;
    }
