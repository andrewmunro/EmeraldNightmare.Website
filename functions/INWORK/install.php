...
<span>Progress 5%</span> [Step 1 of 6]
<div id="progress-bar" class="border-3">
<div id="current-progress" class="border-3" style="width: 5%"></div>
</div>
</div>
<div id="page-header">
...
<h2 class="subcategory">Welcome to the <b>WoWFailureCMS</b> Installer!</h2>
<p> Before we start the installation proccess, we need to make sure your web server is compatible with <b>WoWFailureCMS</b>. Please click Start at the bottom to begin.</p>
<div id="page-content">
