...
<span>Progress 20%</span> [Step 1 of 6]
...
<h2 class="subcategory">Now we are going to set <b>Database</b> Information! </h2>

<div id="page-content">
<form method="post" action="" class="account-merge" id="account-merge">
<div id="wowLogin">
<center><div class="form-row-raf required">
    <label class="label-full">
    <strong>Installation Method:</strong>
    <span class="form-required">*</span>
    </label>
    <span>
    <span class="inline-radio" >Strawberry
    <input type="radio" name="SettingKey" value="manual" checked="true" />
    </span>
	<span class="inline-radio" style="padding-left:20px;">Skyfire
    <input type="radio" name="SettingKey" value="manual"/>
    </span>
	<span class="inline-radio" style="padding-left:20px;">Trinity
    <input type="radio" name="SettingKey" value="manual"/>
    </span>
	<span class="inline-radio" style="padding-left:20px;">Arc-Emu
    <input type="radio" name="SettingKey" value="auto" class="form-disabled" disabled="disabled" />
    </span>
    </span>
    </div>
	<div class="form-row required">
	<label for="host" class="label-full ">
	<strong>Database Host:</strong>
	<span class="form-required">*</span>
	</label>			
    <input type="text" id="host" name="host" value="localhost" class="input border-5 glow-shadow-2" maxlength="255" tabindex="2"/>
	</div>
	<div class="form-row required">
	<label for="host" class="label-full ">
    ...
    <input type="text" id="host" name="host" value="3306" class="input border-5 glow-shadow-2" maxlength="255" tabindex="2"/>
	</div>
	<div class="form-row required">
	<label for="host" class="label-full ">
    ...
    <input type="text" id="host" name="host" value="root" class="input border-5 glow-shadow-2" maxlength="255" tabindex="2"/>
	</div>
	<div class="form-row required">
	<label for="host" class="label-full ">
    ...
    <input type="password" id="host" name="host" value="localhost" class="input border-5 glow-shadow-2" maxlength="255" tabindex="2"/>
	</div>
