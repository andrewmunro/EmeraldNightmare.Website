...
<?php
	...
	echo '<link rel="stylesheet" type="text/css" media="all" href="../wow/static//local-common/css/media-gallery.css">';
	echo '<link rel="stylesheet" type="text/css" media="all" href="../wow/static//css/media/media.css">';
}
}
